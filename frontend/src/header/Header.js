          ...
          <div className={classes.sectionDesktop}>
            <IconButton color="inherit">
              <Badge color="secondary" >
                <Link to="/dashboard" replace="true" style={{ textDecoration: 'none', color: 'white', fontSize: '20px' }}><span  >Dashboard</span></Link>
              </Badge>
            </IconButton>

            <IconButton color="inherit">
              <Badge color="secondary">
                <Link to="/cart" replace="true" style={{ textDecoration: 'none', color: 'white' }}><ShoppingCartIcon /></Link>
              </Badge>
            </IconButton>
